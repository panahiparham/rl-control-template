...
from agents.proposal import ProposalConfig
from agents.proposal import make_train as proposal_make_train
...
def agent_registry(name: str, params: dict[str, Any]):
    ...
    if name == 'Proposal':
        return ProposalConfig(**params), proposal_make_train
